          ...
          <View style={styles.navbar}>
            ...
            <TouchableOpacity onPress={() => this.clearInput()}>
              <Svg  width="48" height="48">
                <Line scale="2" fill="none" strokeWidth="2" stroke="black" x1="4" y1="4" x2="20" y2="20"/>
                <Line scale="2" fill="none" strokeWidth="2" stroke="black" x1="20" y1="4" x2="4" y2="20"/>
              </Svg>
            </TouchableOpacity>
          </View>
        </Modal>
